              ...
              <div className="space-y-12">
                ...
                <AnimateInView delay={0.05}>
                  ...
                  <Body>
                    ...
                    <p>Para assuntos relacionados à privacidade e proteção de dados, entre em contato pelo e-mail: <strong className="text-brand-navy">contato@rubixdigital.com.br</strong></p>
                  </Body>
                </AnimateInView>
                ...
                <AnimateInView delay={0.05}>
                  ...
                  <Body>
                    ...
                    <p className="mt-3">Solicitações podem ser enviadas para: <strong className="text-brand-navy">contato@rubixdigital.com.br</strong></p>
                  </Body>
                </AnimateInView>
