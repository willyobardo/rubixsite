...
const ASSETS = {
  ...
  illustration: 'http://localhost:3845/assets/e88f4723c59f9cd68ca4ee15f31c444adf685cbc.png',
  yellowCircle: 'http://localhost:3845/assets/27f60c0ff6bd9f1c8b3343e54fc4bc300663f555.svg',
}

const ease = [0.25, 0.46, 0.45, 0.94] as const

export function OQueEHero() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="O que é Rubix — Inteligência aplicada à mídia"
      className="relative overflow-hidden rounded-bl-[30px] rounded-br-[30px] lg:rounded-bl-[50px] lg:rounded-br-[50px]"
      style={{
        minHeight: '480px',
        background: 'linear-gradient(40.9deg, rgb(0, 47, 67) 64.904%, rgb(0, 0, 0) 100%)',
      }}
    >
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-[77px] w-full">
        ...
        <div className="flex flex-col lg:hidden pt-12 pb-8">
          ...
          >
            Inteligência aplicada à mídia. Resultados aplicados ao negócio.
          </motion.h1>
          <motion.p
          ...
          >
            A Rubix é uma trading desk que integra dados estruturados, inteligência territorial e execução programática para transformar mídia em vantagem estratégica.
          </motion.p>
          <motion.div
          ...
          {/* Ilustração mobile */}
          <div className="relative mt-8 mx-auto w-full max-w-[340px]">
            <motion.div
            ...
            >
              <Image
                ...
                alt="Dashboard de inteligência territorial Rubix"
                width={340}
                height={295}
                priority
                unoptimized
        ...
        <div className="hidden lg:flex items-center justify-between py-20 xl:py-28 gap-12">
          ...
          >
            ...
            <motion.p
              ...
              transition={{ duration: 0.7, ease, delay: 0.5 }}
            >
              A Rubix é uma trading desk que integra dados estruturados, inteligência territorial e execução programática para transformar mídia em vantagem estratégica. Operamos além da ativação. Estruturamos contexto, qualificamos audiência e entregamos performance com governança.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            style={{ width: '546px', height: '475px', y: illustY }}
          >
            <motion.div
              className="absolute z-0"
              style={{ left: '234px', top: '198px' }}
              initial={{ opacity: 0, scale: 0.5 }}
