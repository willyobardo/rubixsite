...
const ASSETS = {
  ...
  illustration: 'http://localhost:3845/assets/751ad3c3335ccf1dcdaff33e923f90d3f3c487d7.png',
  yellowCircle: 'http://localhost:3845/assets/27f60c0ff6bd9f1c8b3343e54fc4bc300663f555.svg',
}

const ease = [0.25, 0.46, 0.45, 0.94] as const

export function AplicacoesHero() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Aplicações Rubix — Conversões reais"
      className="relative overflow-hidden rounded-bl-[30px] rounded-br-[30px] lg:rounded-bl-[50px] lg:rounded-br-[50px]"
      style={{
        minHeight: '480px',
        background: 'linear-gradient(37.59deg, rgb(0, 47, 67) 64.904%, rgb(0, 0, 0) 100%)',
      }}
    >
      <motion.div className="absolute inset-0 pointer-events-none" style={{ y: bgY }}>
        <Image src={ASSETS.bgTexture} alt="" fill sizes="100vw" className="object-cover" priority unoptimized />
      </motion.div>
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-[77px] w-full">
        ...
        <div className="flex flex-col lg:hidden pt-12 pb-8">
          ...
          >
            Aplicações práticas. Conversões reais.
          </motion.h1>
          <motion.p
          ...
          >
            Conheça como a Rubix aplica inteligência territorial e audiência geolocalizada estratégica para
            impulsionar performance, qualificar impacto e otimizar investimento.
          </motion.p>
          <motion.div
        ...
        <div className="hidden lg:flex items-center justify-between py-20 xl:py-28 gap-12">
          ...
          >
            ...
            <motion.p
              className="font-[family-name:var(--font-inter)] font-normal text-white mt-8 max-w-[535px]"
          ...
          <motion.div
            ...
            style={{ width: '487px', height: '294px', y: illustY }}
          >
            <motion.div
              className="absolute z-0"
