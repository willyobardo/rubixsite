...
export function AboutRubix({ data }: AboutRubixProps) {
  return (
    <section aria-labelledby="about-rubix-title" className="bg-brand-light overflow-hidden">
      <div className="flex flex-col lg:flex-row lg:items-stretch">
        ...
        >
          <div className="absolute inset-0 lg:rounded-tl-[50px] lg:rounded-bl-[50px] overflow-hidden">
            <Image
              src={PHOTO}
              alt="Equipe Rubix trabalhando com dados e mídia programática"
              fill
