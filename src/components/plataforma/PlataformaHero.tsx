...
export function PlataformaHero() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Plataforma Device Tracker"
      className="relative overflow-hidden rounded-bl-[30px] rounded-br-[30px] lg:rounded-bl-[50px] lg:rounded-br-[50px]"
      style={{
        minHeight: '480px',
        background: 'linear-gradient(42.88deg, rgb(0, 47, 67) 64.904%, rgb(0, 0, 0) 100%)',
      }}
    >
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-[77px] w-full">
        ...
        <div className="flex flex-col lg:hidden pt-12 pb-8">
          ...
          >
            Plataforma Device Tracker: Audiências geolocalizadas e resultados tangíveis.
          </motion.h1>
          <motion.p
          ...
          >
            Descubra como a Rubix transforma geolocalização móvel em leitura territorial estratégica e
          ...
          <div className="relative mt-8 mx-auto w-full max-w-[320px]">
            <motion.div
            ...
            >
              <Image
                ...
                alt="Plataforma Device Tracker Rubix"
                width={320}
                height={320}
                priority
                unoptimized
        ...
        <div className="hidden lg:flex items-center justify-between py-20 xl:py-28 gap-12">
          ...
          >
            ...
            >
              Descubra como a Rubix transforma geolocalização móvel em leitura territorial estratégica e
              campanhas de alta performance. Integramos dados de localização, contexto de mercado e
              inteligência comportamental para qualificar audiências antes da ativação.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            style={{ width: '520px', height: '520px', y: illustY }}
          >
            <motion.div
              className="absolute z-0"
