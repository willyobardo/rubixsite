...
const ASSETS = {
  ...
  illustration: 'http://localhost:3845/assets/b29bfe307292e9ac9eeec648aaf189322c9d7f8c.png',
...
export function ComoFuncionaHero() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Como funciona — Metodologia estruturada"
      className="relative overflow-hidden rounded-bl-[30px] rounded-br-[30px] lg:rounded-bl-[50px] lg:rounded-br-[50px]"
      style={{
        minHeight: '480px',
        background: 'linear-gradient(37.55deg, rgb(0, 47, 67) 64.904%, rgb(0, 0, 0) 100%)',
      }}
    >
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-[77px] w-full">
        ...
        <div className="flex flex-col lg:hidden pt-12 pb-8">
          ...
          >
            Metodologia estruturada. Execução orientada por dados.
          </motion.h1>
          <motion.p
          ...
          >
            Da leitura territorial à ativação programática, cada etapa é mensurável e orientada por eficiência.
          </motion.p>
          <motion.div
          ...
          <div className="relative mt-8 mx-auto w-full max-w-[320px]">
            ...
            >
              <Image
                ...
                alt="Metodologia Rubix — execução orientada por dados"
                width={320}
                height={360}
                priority
                unoptimized
        ...
        <div className="hidden lg:flex items-center justify-between py-20 xl:py-28 gap-12">
          ...
          <motion.div
            ...
            style={{ width: '487px', height: '521px', y: illustY }}
          >
            <motion.div
              className="absolute z-0"
